  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <button className="flex items-center gap-3.5 py-3 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base" onClick={handleLogout}>
          <svg
            className="fill-current"
            width="22"
            height="22"
