...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-40 flex h-screen flex-col overflow-y-hidden bg-[#fafafa] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 shadow-2xl shadow-gray-500 w-72 ${
